...
## Spatial h-scatterplot

A spatial h-scatterplot is a scatterplot of paired observations separated by a given distance (lag) $h$.

## Why Spatial h-scatterplot matters

The h-scatterplot provides a visual, pairwise view of spatial dependence at distance $h$.

It is the building block of the variogram.

## Variogram

The variogram summarizes spatial continuity as a function of distance.
